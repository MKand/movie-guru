...
{
  "displayName": "10% - Chat Bad Query Rate - Calendar Day",
  "goal": 0.10,
  "calendarPeriod": "DAY",
  "serviceLevelIndicator": {
    "requestBased": {
      "goodTotalRatio": {
        "badServiceFilter": "metric.type=\"prometheus.googleapis.com/movieguru_chat_wrongQuery_counter_total/counter\" resource.type=\"prometheus_target\"",
