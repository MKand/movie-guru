...
resource "google_service_account" "cloudbuild" {
  account_id   = "movie-guru-cloudbuild-${var.app_name}"
...
resource "google_cloudbuild_trigger" "github-trigger" {
  ...
  ignored_files = ["/ghacks/observability_challenges/deploy", "setup", "utils/nginx", "utils/metrics", "docker-compose*", "Readme.md" ]
  lifecycle {
    ignore_changes = []
  }
