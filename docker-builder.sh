...
# Build the Docker image
docker build -t ${DOCKER_NAME}/movie-guru-locust:$TAG_NAME ./locust
docker push ${DOCKER_NAME}/movie-guru-locust:$TAG_NAME
echo "Image ${DOCKER_NAME}/movie-guru-locust:$TAG_NAME built and pushed successfully!"